...
// import "@fortawesome/fontawesome-free/css/all.min.css"; // Uncomment if needed
    ...
    if (input.trim()) {
      if (isEditing) {
        const updatedList = list.map((item, index) =>
          index === currentIndex ? { title: input, description } : item
        );
        setList(updatedList);
        setIsEditing(false);
        setCurrentIndex(null);
      } else {
        const newItem = { title: input, description };
